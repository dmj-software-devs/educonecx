...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/dashboard/educonecx-academy/context-preference', [DashboardEduconecxAcademyController::class, 'updateContextPreference'])->name('dashboard.educonecx-academy.context-preference');
