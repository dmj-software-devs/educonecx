    ...
    <div class="col-lg-3 col-md-6">
        <div class="stat-mini-card">
            ...
            <div class="stat-mini-content">
                ...
                <span class="stat-mini-value">{{ $courses->total() ?? 0 }}</span>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="stat-mini-card">
            ...
            <div class="stat-mini-content">
                ...
                <span class="stat-mini-value">{{ $courses->where('status', 'published')->count() ?? 0 }}</span>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="stat-mini-card">
            ...
            <div class="stat-mini-content">
                ...
                <span class="stat-mini-value">{{ $courses->where('status', 'draft')->count() ?? 0 }}</span>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="stat-mini-card">
            ...
            <div class="stat-mini-content">
                ...
                <span class="stat-mini-value">{{ number_format($courses->sum('total_students') ?? 0) }}</span>
            </div>
        </div>
    </div>
</div>
