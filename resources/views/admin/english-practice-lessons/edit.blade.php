...
<div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
    <div>
        ...
        <p class="text-muted mb-0">{{ $course->title }} / {{ $lesson->title }}</p>
    </div>
...
<form action="{{ route('admin.english-practice-lessons.update', $lesson) }}" method="POST" enctype="multipart/form-data">@include('admin.english-practice-lessons._form')</form>
@endsection
