    ...
    <main class="academy-main">
        <div class="container">
            ...
            <div class="academy-card mb-4">
                <div class="academy-card-body d-flex align-items-center justify-content-between gap-3 flex-wrap">
                    <div>
                        ...
                        <div class="academy-badge-row">
                            ...
                            <span class="academy-pill"><i class="fas fa-comments"></i> Current LiveAvatar Context: {{ $avatarSetting?->context_name ?: 'Default context' }}</span>
                        </div>
                        @if(config('app.debug'))
                ...
                @if(! $avatarSetting?->heygen_context_id && ! config('services.heygen.default_context_id'))
                    <div class="alert alert-warning mx-4 mb-4">
                        Please select a LiveAvatar context from your EDUCONECX Academy dashboard.
                    </div>
                @elseif(! $avatarSetting?->heygen_avatar_id || ! $avatarSetting?->heygen_context_id)
                    <div class="alert alert-warning mx-4 mb-4">
                        Please select your avatar and LiveAvatar context from your EDUCONECX Academy dashboard, or the configured env fallback will be used.
                    </div>
                @endif
            </div>
