        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <!-- <p class="footer-desc">{{ App\Helpers\TranslationHelper::trans('footer.company_desc') ?? 'Empowering learning, connecting futures. International interactive educational platform that empowers learners worldwide with practical language and digital business skills.' }}</p> -->
