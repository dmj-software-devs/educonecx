            ...
            <div class="header-content">
                ...
                <nav class="desktop-nav">
                    <ul class="nav-menu">
                        ...
                        @if(Auth::check() && Auth::user()->canAccessPracticeRoom())
                        <li><a href="{{ route('educonecx.academy.index') }}" class="{{ request()->routeIs('educonecx.academy.*') ? 'active' : '' }}"><span>Practice Room</span></a></li>
                        @endif
                        ...
                        <li><a href="{{ route('progressive-quizzes.index') }}" class="{{ request()->routeIs('progressive-quizzes.*') ? 'active' : '' }}"><span class="translate-text" data-original="{{ App\Helpers\TranslationHelper::trans('header.quiz') }}">{{ App\Helpers\TranslationHelper::trans('header.quiz') }}</span></a></li>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <nav class="mobile-nav">
            <ul class="mobile-nav-list">
                ...
                @if(Auth::check() && Auth::user()->canAccessPracticeRoom())
                <li><a href="{{ route('educonecx.academy.index') }}" class="{{ request()->routeIs('educonecx.academy.*') ? 'active' : '' }}"><i class="fas fa-chalkboard-teacher"></i> <span>Practice Room</span></a></li>
                @endif
