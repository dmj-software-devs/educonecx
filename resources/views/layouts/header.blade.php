            ...
            <div class="header-content">
                ...
                <nav class="desktop-nav">
                    <ul class="nav-menu">
                        ...
                        <li><a href="{{ route('educonecx.academy.index') }}" class="{{ request()->routeIs('educonecx.academy.*') ? 'active' : '' }}"><span>EDUCONECX Academy</span></a></li>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <nav class="mobile-nav">
            <ul class="mobile-nav-list">
                ...
                <li><a href="{{ route('educonecx.academy.index') }}" class="{{ request()->routeIs('educonecx.academy.*') ? 'active' : '' }}"><span>EDUCONECX Academy</span></a></li>
                        <li><a href="{{ route('educonecx.academy.index') }}" class="{{ request()->routeIs('educonecx.academy.*') ? 'active' : '' }}"><i class="fas fa-robot"></i> <span>EDUCONECX Academy</span></a></li>
