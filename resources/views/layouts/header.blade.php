        ...
        ">
            ...
            <nav class="main-nav" style="flex: 1; margin: 0 30px;">
                ...
                ">
                    ...
                    <li><a href="{{ route('courses') }}" class="{{ request()->routeIs('courses') ? 'active' : '' }}" style="font-weight: 500; padding: 5px 0; border-bottom: 2px solid transparent; transition: all 0.3s;">All Courses</a></li>
